...
export class VintedService {
  ...
  async getItems(): Promise<Product[]> {
    ...
    const url =
      'https://www.vinted.lt/api/v2/catalog/items?page=1&per_page=500&time=1764789874&search_text=&catalog_ids=1231&order=relevance&size_ids=787,788,789=&brand_ids=53,2703,14,139,1775,535,11445,5977,2369,44,162,1195,309,2239,110434,51021,3203,283953&status_ids=&color_ids=&material_ids=';
